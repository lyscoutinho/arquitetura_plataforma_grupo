...
import { Plus, Search, MoreHorizontal, FileText, Filter, ArrowUpDown, Loader2 } from "lucide-react"
import { useAppContext } from "@/app/context/AppContext"
import { apiGetContratos } from "@/lib/api"
                                        ...
                                        filteredContracts.map((contract) => (
                                            <TableRow key={contract.id} className="border-gray-800 hover:bg-gray-900/30">
                                                ...
                                                <TableCell className="text-gray-300">
                                                    {typeof contract.cliente === 'object' ? contract.cliente.nome : contract.cliente}
                                                </TableCell>
                                                <TableCell className="text-gray-300 font-medium">
                                                    {formatCurrency(contract.valor || 0)}
                                                </TableCell>
                                                <TableCell className="text-gray-400 text-sm">
                                                    {formatDate(contract.dataInicio)} {contract.dataFim ? `- ${formatDate(contract.dataFim)}` : ''}
                                                </TableCell>
                                                <TableCell>
